...
## Channel Attention (SRE) Layer
class SRELayer(nn.Module):
    def __init__(self, channel, reduction=16):
        super(SRELayer, self).__init__()
...
class RCAB(nn.Module):
    def __init__(
        ...
        modules_body.append(SRELayer(n_feat, reduction))
...
## Squeeze-and-Residual-Excitation based Aggregated Attention Network (SRE-AAN)
class SRE_AAN(nn.Module):
    def __init__(self, args, conv=model.common.default_conv):
        super(SRE_AAN, self).__init__()
